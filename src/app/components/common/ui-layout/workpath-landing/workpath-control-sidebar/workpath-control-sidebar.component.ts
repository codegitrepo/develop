...
@Component({
  selector: 'app-workpath-control-sidebar',
  templateUrl: './workpath-control-sidebar.component.html',
  styleUrls: ['./workpath-control-sidebar.component.scss']
})
export class WorkpathControlSidebarComponent implements OnInit {
